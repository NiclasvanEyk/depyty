...
If you e.g. want to look what the `analyze` command does, go to
`depyty.cli.commands.analyze` and inspect the `run` method. This gets called
when a user runs `depyty analyze`.
"""
